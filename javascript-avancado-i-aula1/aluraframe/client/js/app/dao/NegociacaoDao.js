                ...
                _createClass(NegociacaoDao, [{
                    ...
                    value: function listaTodos() {
                        ...
                        return new Promise(function (resolve, reject) {
                            ...
                            cursor.onsuccess = function (e) {
                                var atual = e.target.result; // ponteiro para uma negociação para o banco    
                    ...
                    value: function apagaTodos() {
                        ...
                        return new Promise(function (resolve, reject) {
                            ...
                            var request = _this3._connection.transaction([_this3._store], 'readwrite').objectStore(_this3._store).clear(); // apaga os dados da objectStore   
